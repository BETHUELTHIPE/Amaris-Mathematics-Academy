  ...
  return (
    <main className="min-h-screen bg-[#f5f7fb] text-[#0a1b36]">
      ...
      <section className="relative isolate overflow-hidden bg-[#07152d] text-white">
        <Image src="/amaris-math-hero.png" alt="A student working through mathematics in a focused study environment" fill priority quality={90} unoptimized={process.env.NODE_ENV !== "production"} className="object-cover object-[62%_center] opacity-90" sizes="100vw" />
        ...
        <div className="relative mx-auto grid min-h-[690px] max-w-7xl items-center px-5 py-20 lg:px-8">
          <div className="max-w-2xl">
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row"><Link href="/courses" className="inline-flex items-center justify-center gap-2 rounded-full bg-[#ffcc66] px-6 py-3.5 font-bold text-[#07152d] transition hover:bg-[#ffd780]">Browse courses <ArrowRight className="size-4" /></Link><Link href="/how-it-works" className="inline-flex items-center justify-center gap-2 rounded-full border border-white/25 bg-white/8 px-6 py-3.5 font-semibold text-white backdrop-blur transition hover:bg-white/15"><CirclePlay className="size-4" /> See how it works</Link></div>
