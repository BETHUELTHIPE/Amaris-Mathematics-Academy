...
export function EnquiryForm() {
  ...
  return (
    <form action={formAction} className="mt-8 space-y-6">
      ...
      <div><label className="flex items-start gap-3 text-sm leading-6 text-[#60708a]"><Checkbox id="consent" name="consent" required aria-label="Consent to use enquiry details" value="on" aria-invalid={Boolean(state.errors?.consent)} className="mt-1 border-[#9aabc0] data-[state=checked]:border-[#1f5bbd] data-[state=checked]:bg-[#1f5bbd]" /><span>I agree that Amaris Mathematics Academy may use these details to respond to my enquiry. <span className="text-[#b42318]">*</span></span></label><FieldError message={state.errors?.consent} /></div>
