  ...
  return (
    <>
      <div className="hidden min-w-[13rem] items-center justify-end gap-3 lg:flex">
        {authenticated ? (
          <>
            {verified && <a href="/documents" className="text-sm font-semibold text-white/70 hover:text-white">Documents</a>}
      ...
      <details className="relative lg:hidden">
        ...
        <div className="absolute right-0 mt-3 w-64 rounded-2xl border border-white/10 bg-[#0c2042] p-3 shadow-2xl">
          ...
          {verified && <a href="/documents" className="block rounded-xl px-3 py-2.5 text-sm text-white/80 hover:bg-white/10">Documents & invoices</a>}
