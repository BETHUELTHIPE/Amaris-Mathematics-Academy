...
export function EnquiryForm() {
  ...
  return (
    <form action={formAction} className="mt-8 space-y-6">
      ...
      <div><div className="flex items-start gap-3 text-sm leading-6 text-[#60708a]"><Checkbox id="consent" name="consent" required value="on" aria-labelledby="consent-label" aria-invalid={Boolean(state.errors?.consent)} className="mt-1 border-[#9aabc0] data-[state=checked]:border-[#1f5bbd] data-[state=checked]:bg-[#1f5bbd]" /><span id="consent-label">I agree that Amaris Mathematics Academy may use these details to respond to my enquiry. <span className="text-[#b42318]">*</span></span></div><FieldError message={state.errors?.consent} /></div>
