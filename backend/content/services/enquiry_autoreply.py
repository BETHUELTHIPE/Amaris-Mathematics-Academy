...
def _support_instructions() -> str:
    return (
        ...
        "The supplied website content is the source of truth; do not rely on general knowledge, memory, "
        "or assumptions. "
        "Prefer current published CMS values, routes, prices, courses, FAQs, page content, calls-to-action, and active "
        "navigation exactly as supplied. Treat the Official website student workflow as authoritative for "
        "registration, "
        ...
        "supplied content. Do not use this fallback when a workflow, course, pricing plan, FAQ, page, CTA, or "
        "navigation "
        ...
        "Keep the reply concise, warm, professional, and plain text. Start with a greeting using the client's "
        "first name "
