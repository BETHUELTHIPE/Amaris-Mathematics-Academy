...
OPENAI_ASSISTANT_MODEL = os.getenv("OPENAI_ASSISTANT_MODEL") or OPENAI_ENQUIRY_MODEL
OPENAI_ASSISTANT_TIMEOUT_SECONDS = float(os.getenv("OPENAI_ASSISTANT_TIMEOUT_SECONDS", "12"))
